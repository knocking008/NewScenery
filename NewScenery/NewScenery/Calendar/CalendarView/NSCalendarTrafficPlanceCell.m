...
@implementation NSCalendarTrafficPlanceCell
...
{
    self.daliy_time_textLabel.text = model.daliy_time_text;
    ...
    self.target_city_enLabel.text = model.target_city_en;
    self.start_timeLabel.text = model.start_time;
    self.arrive_timeLabel.text = model.arrive_time;
    self.daliy_date_md1.text = [self getDateByDateStr:model.daliy_date];
    self.daliy_date_md2.text = [self getDateByDateStr:model.daliy_date];
